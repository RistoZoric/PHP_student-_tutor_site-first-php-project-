...
<body>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-white w3-card" id="myNavbar">
      ...
      <div class="w3-right w3-hide-small">
        <a href="./page/auth/register.php" id="signuP" class="w3-bar-item w3-button"><i class="fa fa-user-plus"></i>
          Sign Up</a>
        <a href="./page/auth/login.php" id="login" class="w3-bar-item w3-button"><i class="fa fa-user"></i> Login</a>
      </div>
  ...
  <header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
    <div class="w3-display-left w3-text-white" style="padding:48px">
      <span class="w3-jumbo w3-hide-small">Wellcome to our site</span><br>
      <span class="w3-xxlarge w3-hide-large w3-hide-medium">Start something that matters</span><br>
      <span class="w3-large">Student rating managing system.</span>
      <p><a href="#work"
          class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Learn more</a></p>
    </div>
